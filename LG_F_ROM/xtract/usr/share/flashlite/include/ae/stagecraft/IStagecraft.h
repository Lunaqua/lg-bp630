...
public:
	...
	virtual bool PluginGetDebugPrintStatus() = 0;
	
	// 20101220 DYKim
	virtual u32 GetMaxMemoryLimit() = 0;
    ...
    virtual void  *GetContentsPath() = 0;
    virtual void        SetExecutePID(u16 nExecutePID) = 0;	

#ifdef SUPPORT_1G_ARCH
	virtual u64								GetAuid() = 0;
	virtual void 							SetAuid(u64 id) = 0;
#endif

#ifdef SC_BDP	//.. GENE 20100916
		int m_OutputdimsW;
		int m_OutputdimsH;	
		int m_ExitCode;			//.. GENE 20110721 Plug-in일 경우 사용하지 않으므로 어플 구분 용도로 사용. ex) 999면 tou.tv
		void * m_pNotifier;
#endif
...
{
#endif
	//ae::stagecraft::IStagecraft *gInitializeStagecraftLibrary(int argc, const char ** argv);
	void *gInitializeStagecraftLibrary(int argc, const char ** argv);
#ifdef __cplusplus
}
#endif
#endif
...
// 20120208 gene_lee Release Ver. 2.20.00.02 for mt8560
