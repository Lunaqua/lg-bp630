...
//[CJ] MTK_PORT
    bool                    m_bFullscreen;              /// only for fullscreen, but not use gfx to scale
    const char *            m_pProxyURL;                /// for proxy setting
//--
};
...
public:
    ...
    virtual bool RefreshPlane(s32 x, s32 y, u32 w, u32 h) = 0;
//--
protected:
    virtual ~StageWindow() { }
};
