...
public class l extends android.support.v7.view.menu.c<android.support.v4.d.a.b> implements MenuItem {
    static final String c = "MenuItemWrapper";
    private Method d;
    ...
    public class a extends android.support.v4.view.b {
        ...
        public void a(SubMenu subMenu) {
            this.a.onPrepareSubMenu(l.this.a(subMenu));
        }
    ...
    private class c extends android.support.v7.view.menu.d<MenuItem.OnActionExpandListener> implements MenuItem.OnActionExpandListener {
        ...
        public boolean onMenuItemActionCollapse(MenuItem menuItem) {
            return ((MenuItem.OnActionExpandListener) this.b).onMenuItemActionCollapse(l.this.a(menuItem));
        }

        @Override // android.view.MenuItem.OnActionExpandListener
        public boolean onMenuItemActionExpand(MenuItem menuItem) {
            return ((MenuItem.OnActionExpandListener) this.b).onMenuItemActionExpand(l.this.a(menuItem));
        }
    }
    ...
    private class d extends android.support.v7.view.menu.d<MenuItem.OnMenuItemClickListener> implements MenuItem.OnMenuItemClickListener {
        ...
        public boolean onMenuItemClick(MenuItem menuItem) {
            return ((MenuItem.OnMenuItemClickListener) this.b).onMenuItemClick(l.this.a(menuItem));
        }
    }
    ...
    public void a(boolean z) {
        try {
            if (this.d == null) {
                this.d = ((android.support.v4.d.a.b) this.b).getClass().getDeclaredMethod("setExclusiveCheckable", Boolean.TYPE);
            }
            this.d.invoke(this.b, Boolean.valueOf(z));
        } catch (Exception e) {
            Log.w(c, "Error while calling setExclusiveCheckable", e);
        }
    }
    ...
    public ActionProvider getActionProvider() {
        android.support.v4.view.b a2 = ((android.support.v4.d.a.b) this.b).a();
        if (a2 instanceof a) {
            return ((a) a2).a;
        }
        return null;
    ...
    public MenuItem setAlphabeticShortcut(char c2) {
        ((android.support.v4.d.a.b) this.b).setAlphabeticShortcut(c2);
        return this;
    }

    @Override // android.view.MenuItem
    public MenuItem setAlphabeticShortcut(char c2, int i) {
        ((android.support.v4.d.a.b) this.b).setAlphabeticShortcut(c2, i);
        return this;
    }
    ...
    public MenuItem setNumericShortcut(char c2) {
        ((android.support.v4.d.a.b) this.b).setNumericShortcut(c2);
        return this;
    }

    @Override // android.view.MenuItem
    public MenuItem setNumericShortcut(char c2, int i) {
        ((android.support.v4.d.a.b) this.b).setNumericShortcut(c2, i);
        return this;
    }

    @Override // android.view.MenuItem
    public MenuItem setOnActionExpandListener(MenuItem.OnActionExpandListener onActionExpandListener) {
        ((android.support.v4.d.a.b) this.b).setOnActionExpandListener(onActionExpandListener != null ? new c(onActionExpandListener) : null);
        return this;
    }

    @Override // android.view.MenuItem
    public MenuItem setOnMenuItemClickListener(MenuItem.OnMenuItemClickListener onMenuItemClickListener) {
        ((android.support.v4.d.a.b) this.b).setOnMenuItemClickListener(onMenuItemClickListener != null ? new d(onMenuItemClickListener) : null);
        return this;
    }

    @Override // android.view.MenuItem
    public MenuItem setShortcut(char c2, char c3) {
        ((android.support.v4.d.a.b) this.b).setShortcut(c2, c3);
        return this;
    }

    @Override // android.view.MenuItem
    public MenuItem setShortcut(char c2, char c3, int i, int i2) {
        ((android.support.v4.d.a.b) this.b).setShortcut(c2, c3, i, i2);
        return this;
    }
