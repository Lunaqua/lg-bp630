...
public class AlertDialogLayout extends LinearLayoutCompat {
    public AlertDialogLayout(@android.support.annotation.ag Context context) {
        super(context);
    }

    public AlertDialogLayout(@android.support.annotation.ag Context context, @android.support.annotation.ag AttributeSet attributeSet) {
    ...
    private static int c(View view) {
        int B = android.support.v4.view.ab.B(view);
        if (B > 0) {
            return B;
        }
        ...
        for (int i7 = 0; i7 < childCount; i7++) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                if (id == a.g.topPanel) {
                    ...
                    view2 = childAt;
                } else if ((id != a.g.contentPanel && id != a.g.customPanel) || view3 != null) {
                    return false;
                } else {
                    view3 = childAt;
                }
    ...
    */
    public void onLayout(boolean r18, int r19, int r20, int r21, int r22) {
        ...
        L5a:
            ...
            r2 = r11
        L7e:
            int r3 = android.support.v4.view.ab.m(r17)
            int r2 = android.support.v4.view.f.a(r2, r3)
            r2 = r2 & 7
            r3 = 1
            if (r2 == r3) goto L95
            r3 = 5
