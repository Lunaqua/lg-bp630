...
public class FragmentTabHost extends TabHost implements TabHost.OnTabChangeListener {
    ...
    public static final class TabInfo {
        ...
        TabInfo(@af String str, @af Class<?> cls, @ag Bundle bundle) {
            this.tag = str;
            this.clss = cls;
            this.args = bundle;
        }
    ...
    @ag
    private FragmentTransaction doTabChanged(@ag String str, @ag FragmentTransaction fragmentTransaction) {
    ...
    public void addTab(@af TabHost.TabSpec tabSpec, @af Class<?> cls, @ag Bundle bundle) {
