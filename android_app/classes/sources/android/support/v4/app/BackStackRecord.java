...
public final class BackStackRecord extends FragmentTransaction implements FragmentManager.BackStackEntry, FragmentManagerImpl.OpGenerator {
    ...
    private void doAddOp(int i, Fragment fragment, @ag String str, int i2) {
    ...
    @Override // android.support.v4.app.FragmentTransaction
    public FragmentTransaction add(int i, Fragment fragment, @ag String str) {
        doAddOp(i, fragment, str, 1);
        return this;
    }

    @Override // android.support.v4.app.FragmentTransaction
    public FragmentTransaction add(Fragment fragment, @ag String str) {
    ...
    int commitInternal(boolean z) {
        ...
        if (FragmentManagerImpl.DEBUG) {
            ...
            PrintWriter printWriter = new PrintWriter(new i(TAG));
    ...
    @Override // android.support.v4.app.FragmentTransaction
    public FragmentTransaction replace(int i, Fragment fragment, @ag String str) {
        if (i != 0) {
