...
public class Fragment implements f, u, ComponentCallbacks, View.OnCreateContextMenuListener {
    ...
    l<f> mViewLifecycleOwnerLiveData = new l<>();
    ...
    public LayoutInflater getLayoutInflater(@ag Bundle bundle) {
        ...
        if (fragmentHostCallback != null) {
            ...
            i.a(onGetLayoutInflater, this.mChildFragmentManager.getLayoutInflaterFactory());
    ...
    @af
    public final String getString(@aq int i, Object... objArr) {
    ...
    public f getViewLifecycleOwner() {
        f fVar = this.mViewLifecycleOwner;
        if (fVar != null) {
            return fVar;
        }
    ...
    public void onDestroy() {
        ...
        z = (activity == null || !activity.isChangingConfigurations()) ? false : false;
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public void performCreateView(@af LayoutInflater layoutInflater, @ag ViewGroup viewGroup, @ag Bundle bundle) {
        FragmentManagerImpl fragmentManagerImpl = this.mChildFragmentManager;
        if (fragmentManagerImpl != null) {
            fragmentManagerImpl.noteStateNotSaved();
        }
        this.mPerformedCreateView = true;
        this.mViewLifecycleOwner = new f() { // from class: android.support.v4.app.Fragment.3
            @Override // android.arch.lifecycle.f
            public d getLifecycle() {
                if (Fragment.this.mViewLifecycleRegistry == null) {
                    Fragment fragment = Fragment.this;
                    fragment.mViewLifecycleRegistry = new g(fragment.mViewLifecycleOwner);
                }
    ...
    public void performDestroyView() {
        if (this.mView != null) {
            this.mViewLifecycleRegistry.a(d.a.ON_DESTROY);
        }
        FragmentManagerImpl fragmentManagerImpl = this.mChildFragmentManager;
        if (fragmentManagerImpl != null) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    @af
    public LayoutInflater performGetLayoutInflater(@ag Bundle bundle) {
    ...
    public void performPause() {
        if (this.mView != null) {
            this.mViewLifecycleRegistry.a(d.a.ON_PAUSE);
        }
    ...
    public void performResume() {
        ...
        if (this.mView != null) {
            this.mViewLifecycleRegistry.a(d.a.ON_RESUME);
        }
    }
    ...
    public void performStart() {
        ...
        if (this.mView != null) {
            this.mViewLifecycleRegistry.a(d.a.ON_START);
        }
    }
    ...
    public void performStop() {
        if (this.mView != null) {
            this.mViewLifecycleRegistry.a(d.a.ON_STOP);
        }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public void restoreChildFragmentState(@ag Bundle bundle) {
    ...
    public final void restoreViewState(Bundle bundle) {
        ...
        if (this.mCalled) {
            if (this.mView != null) {
                this.mViewLifecycleRegistry.a(d.a.ON_CREATE);
                return;
            }
            return;
        }
