...
public final class FragmentManagerImpl extends FragmentManager implements LayoutInflater.Factory2 {
    ...
    public static class AnimateOnHWLayerIfNeededListener extends AnimationListenerWrapper {
        ...
        public void onAnimationEnd(Animation animation) {
            if (ab.af(this.mView) || Build.VERSION.SDK_INT >= 24) {
    ...
    public static class EndViewTransitionAnimator extends AnimationSet implements Runnable {
        ...
        EndViewTransitionAnimator(@af Animation animation, @af ViewGroup viewGroup, @af View view) {
            super(false);
    ...
    private void addAddedFragments(b<Fragment> bVar) {
    ...
    private void animateRemoveFragment(@af final Fragment fragment, @af AnimationOrAnimator animationOrAnimator, int i) {
    ...
    private void makeRemovedFragmentsInvisible(b<Fragment> bVar) {
        int size = bVar.size();
        for (int i = 0; i < size; i++) {
            Fragment b = bVar.b(i);
            if (!b.mAdded) {
    ...
    private int postponePostponableTransactions(ArrayList<BackStackRecord> arrayList, ArrayList<Boolean> arrayList2, int i, int i2, b<Fragment> bVar) {
        int i3 = i2;
    ...
    static boolean shouldRunOnHWLayer(View view, AnimationOrAnimator animationOrAnimator) {
        return view != null && animationOrAnimator != null && Build.VERSION.SDK_INT >= 19 && view.getLayerType() == 0 && ab.T(view) && modifiesAlpha(animationOrAnimator);
    }
    ...
    void dispatchOnFragmentActivityCreated(@af Fragment fragment, @ag Bundle bundle, boolean z) {
    ...
    void dispatchOnFragmentAttached(@af Fragment fragment, @af Context context, boolean z) {
        Fragment fragment2 = this.mParent;
        if (fragment2 != null) {
            FragmentManager fragmentManager = fragment2.getFragmentManager();
            if (fragmentManager instanceof FragmentManagerImpl) {
    ...
    void dispatchOnFragmentCreated(@af Fragment fragment, @ag Bundle bundle, boolean z) {
        Fragment fragment2 = this.mParent;
        if (fragment2 != null) {
            FragmentManager fragmentManager = fragment2.getFragmentManager();
            if (fragmentManager instanceof FragmentManagerImpl) {
    ...
    void dispatchOnFragmentDestroyed(@af Fragment fragment, boolean z) {
        Fragment fragment2 = this.mParent;
        if (fragment2 != null) {
            FragmentManager fragmentManager = fragment2.getFragmentManager();
            if (fragmentManager instanceof FragmentManagerImpl) {
    ...
    void dispatchOnFragmentDetached(@af Fragment fragment, boolean z) {
        Fragment fragment2 = this.mParent;
        if (fragment2 != null) {
            FragmentManager fragmentManager = fragment2.getFragmentManager();
            if (fragmentManager instanceof FragmentManagerImpl) {
    ...
    void dispatchOnFragmentPaused(@af Fragment fragment, boolean z) {
        Fragment fragment2 = this.mParent;
        if (fragment2 != null) {
            FragmentManager fragmentManager = fragment2.getFragmentManager();
            if (fragmentManager instanceof FragmentManagerImpl) {
    ...
    void dispatchOnFragmentPreAttached(@af Fragment fragment, @af Context context, boolean z) {
        Fragment fragment2 = this.mParent;
        if (fragment2 != null) {
            FragmentManager fragmentManager = fragment2.getFragmentManager();
            if (fragmentManager instanceof FragmentManagerImpl) {
    ...
    void dispatchOnFragmentPreCreated(@af Fragment fragment, @ag Bundle bundle, boolean z) {
        Fragment fragment2 = this.mParent;
        if (fragment2 != null) {
            FragmentManager fragmentManager = fragment2.getFragmentManager();
            if (fragmentManager instanceof FragmentManagerImpl) {
    ...
    void dispatchOnFragmentResumed(@af Fragment fragment, boolean z) {
        Fragment fragment2 = this.mParent;
        if (fragment2 != null) {
            FragmentManager fragmentManager = fragment2.getFragmentManager();
            if (fragmentManager instanceof FragmentManagerImpl) {
    ...
    void dispatchOnFragmentSaveInstanceState(@af Fragment fragment, @af Bundle bundle, boolean z) {
        Fragment fragment2 = this.mParent;
        if (fragment2 != null) {
            FragmentManager fragmentManager = fragment2.getFragmentManager();
            if (fragmentManager instanceof FragmentManagerImpl) {
    ...
    void dispatchOnFragmentStarted(@af Fragment fragment, boolean z) {
        Fragment fragment2 = this.mParent;
        if (fragment2 != null) {
            FragmentManager fragmentManager = fragment2.getFragmentManager();
            if (fragmentManager instanceof FragmentManagerImpl) {
    ...
    void dispatchOnFragmentStopped(@af Fragment fragment, boolean z) {
        Fragment fragment2 = this.mParent;
        if (fragment2 != null) {
            FragmentManager fragmentManager = fragment2.getFragmentManager();
            if (fragmentManager instanceof FragmentManagerImpl) {
    ...
    void dispatchOnFragmentViewCreated(@af Fragment fragment, @af View view, @ag Bundle bundle, boolean z) {
        Fragment fragment2 = this.mParent;
        if (fragment2 != null) {
            FragmentManager fragmentManager = fragment2.getFragmentManager();
            if (fragmentManager instanceof FragmentManagerImpl) {
    ...
    void dispatchOnFragmentViewDestroyed(@af Fragment fragment, boolean z) {
        Fragment fragment2 = this.mParent;
        if (fragment2 != null) {
            FragmentManager fragmentManager = fragment2.getFragmentManager();
            if (fragmentManager instanceof FragmentManagerImpl) {
