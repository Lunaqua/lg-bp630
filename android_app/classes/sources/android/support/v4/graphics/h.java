...
class h extends l {
    private static final String a = "TypefaceCompatApi21Impl";
    ...
    public android.graphics.Typeface a(android.content.Context r5, android.os.CancellationSignal r6, @android.support.annotation.af android.support.v4.h.d.c[] r7, int r8) {
        /*
            r4 = this;
            int r0 = r7.length
            r1 = 0
            ...
            return r1
        L6:
            android.support.v4.h.d$c r7 = r4.a(r7, r8)
        ...
        L77:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.v4.graphics.h.a(android.content.Context, android.os.CancellationSignal, android.support.v4.h.d$c[], int):android.graphics.Typeface");
    }
}
