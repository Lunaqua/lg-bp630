...
public final class Excluder implements TypeAdapterFactory, Cloneable {
    ...
    public Excluder withExclusionStrategy(ExclusionStrategy exclusionStrategy, boolean z, boolean z2) {
        Excluder m2clone = m2clone();
        if (z) {
            m2clone.serializationStrategies = new ArrayList(this.serializationStrategies);
            m2clone.serializationStrategies.add(exclusionStrategy);
        }
        if (z2) {
            m2clone.deserializationStrategies = new ArrayList(this.deserializationStrategies);
            m2clone.deserializationStrategies.add(exclusionStrategy);
        }
        return m2clone;
    }
