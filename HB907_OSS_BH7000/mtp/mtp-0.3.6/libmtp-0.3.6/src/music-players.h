 ...
 */
 ...
 // { "Philips", 0x0471, "HDD14XX,HDD1620 or HDD1630/17", 0x014c, DEVICE_FLAG_NONE },
  ...
  //added by bin liu
  { "Philips", 0x0471, "GoGear SA44XX", 0x2026,DEVICE_FLAG_UNLOAD_DRIVER },
  // From a
  ...
  //Regard as normal USB as nucleus board. 
  //{ "Philips", 0x0471, "SA401X", 0x841, DEVICE_FLAG_UNLOAD_DRIVER },
 ...
 //   DEVICE_FLAG_IRIVER_OGG_ALZHEIMER },
  ...
  { "Canon", 0x04a9, "Canon DIGITAL IXUS i zoom", 0x30f4,DEVICE_FLAG_NONE|DEVICE_FLAG_NO_ZERO_READS},
  ...
  //regard as normal USB for bug fixed
  ...
  { "Sony", 0x054c, "DSC-T70", 0x02f8, DEVICE_FLAG_UNLOAD_DRIVER },
  { "Sony", 0x054c, "DSC-XXX", 0x004e, DEVICE_FLAG_UNLOAD_DRIVER },
