...
KeyMap::KeyMap()
{
    ...
    insert(DIKS_POWER                 , Qt::Key_PowerOff);
    insert(DIKS_INFO                  , Qt::Key_Display);
    insert(DIKS_EJECT                 , Qt::Key_Eject);
    insert(DIKS_EPG                   , Qt::Key_TopMenu);
    insert(DIKS_PC                    , Qt::Key_Community);
    insert(DIKS_TITLE                 , Qt::Key_MenuPB);
    insert(DIKS_RED                   , Qt::Key_Calculator);
    insert(DIKS_GREEN                 , Qt::Key_AddFavorite);
    insert(DIKS_BLUE                  , Qt::Key_News);
    insert(DIKS_YELLOW                , Qt::Key_Zoom);
    insert(DIKS_FASTFORWARD           , Qt::Key_AudioForward);
    insert(DIKS_REWIND                , Qt::Key_AudioRewind);
    insert(DIKS_SHUFFLE               , Qt::Key_AudioRepeat);
    insert(DIKS_AB                    , Qt::Key_AudioRandomPlay);
    insert(DIKS_LIST                  , Qt::Key_AudioCycleTrack);
    insert(DIKS_SUBTITLE              , Qt::Key_Subtitle);
    insert(DIKS_AUDIO                 , Qt::Key_Music);
    insert(DIKS_ANGLE                 , Qt::Key_View);
    insert(DIKS_MODE                  , Qt::Key_Flip);
}
