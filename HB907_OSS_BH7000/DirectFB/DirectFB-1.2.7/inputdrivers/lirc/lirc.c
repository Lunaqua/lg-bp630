...
lircEventThread( DirectThread *thread, void *driver_data )
{
     ...
     while (true) {
          ...
          tv.tv_sec  = 0;
          tv.tv_usec = 200000; //hywu 200000 -> 20000 for netflix.
...
driver_get_available( void )
{
     ...
     direct_snputs( addr.sun_path, "/var/lircd", sizeof(addr.sun_path) );
                    ...
                    void            **driver_data )
{
     ...
     direct_snputs( sa.sun_path, "/var/lircd", sizeof(sa.sun_path) );
