...
/****************************************************************************/
void get_enter(int i4Times)
{
#if CONFIG_MT85XX_FPGA
    puts ("\b\b\b 0");
    _i4AbortBootup = 1;         /* don't auto boot	*/
#else
   while(i4Times >= 0)
   {
     if (tstc())
...
# endif
     ////mtk40143
    REG_SER_INT_EN = REG_SER_INT_EN & 0xFFFFFFFE;
