...
//  fix alignment fault in 538x.
	__u8	fatbuf[8192*FATBUFBLOCKS] __attribute__ ((aligned (8))); /* Current FAT buffer */
...
extern int x_match_file_from_dir(const char *device,const char *part, const char *dir, const char *matchfile, char *outfilename);
