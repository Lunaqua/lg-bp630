...
#define NFI_FDM0L		((volatile u32 *)(NFI_BASE+0xA0))
#define NFI_FDM0M	   ((volatile u32 *)(NFI_BASE+0xA4))
...
#ifdef ARCH_MT8520
#define NFI_CLK_SEL       ((volatile u32 *)(CKGEN_BASE+0x68))
#else
#define NFI_CLK_SEL       ((volatile u32 *)(CKGEN_BASE+0x70))
#endif

#define PAD_CFG_1           ((volatile u32 *)(CKGEN_BASE+0xC4))
    #define SD2_SEL         0x2000
...
#define FDM_NUM(x)                (((u32) x &0x0F) << 8)
#define FDM_ECC_NUM(x)                (((u32) x &0x0F) << 12)
